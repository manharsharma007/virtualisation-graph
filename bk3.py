...
def walk(graph, root, length = 10, visited_ = {}, color_map = {}):
    ...
    color = {'r' : random.randint(180,255), 'g' : random.randint(180,255), 'b' : random.randint(180,255), 'a' : 180}
    ...
    for k in range(length):
        ...
        if(graph[vertex]["nbrs"]):
            ...
            if(trail in visited_):
                ...
                color_map[trail] = convert_to_hex({"red" : color['r'], "green" : color['g'], "blue" : color['b'], "alpha" : color['a'] })

                color['r'] = color['r'] - color['r'] * 0.075
                color['g'] = color['g'] - color['g'] * 0.055
                color['b'] = color['b'] - color['b'] * 0.065
